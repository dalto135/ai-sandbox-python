...
def index():
    ...
    if request.method == "POST":
        ...
        # folder_path = os.path.expanduser(f'~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Images/AI/image_folder_{folder_datetime}')
        # prompt_file_path = os.path.expanduser(f'~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Images/AI/image_folder_{folder_datetime}/prompts.txt')
    ...
    return render_template("index.html", len=1, images=images, prompt=prompt, api_key=api_key)
